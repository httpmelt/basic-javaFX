    ...
    public StudentList readData() {
        ...
        try {
            ...
            while ( (line = buffer.readLine()) != null ){
                ...
                students.addNewStudent(id, name, score); // Project เปลี่ยน
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
        }

        return students;// Project เปลี่ยน
    }
